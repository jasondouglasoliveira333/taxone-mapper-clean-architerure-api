...
public class FileHelper {
    ...
    public static List<DSColumnDomain> getFileMetadata(DataSourceConfigurationDomain dsDTO) {
        List<DSColumnDomain> dscList = new ArrayList<>();
    ...
    public static List<DSColumnDomain> generateDTOs(File f) throws Exception {
        List<DSColumnDomain> dscList = new ArrayList<>();
